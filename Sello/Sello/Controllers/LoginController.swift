...
class LoginController: UIViewController {
    ...
    lazy var loginRegisterButton: UIButton = {
        ...
        button.backgroundColor = UIColor(r: 108, g: 198, b: 198)
    ...
    func handleRegister() {
        ...
        if checkUser(username: email) == error.success{
            Auth.auth().createUser(withEmail: email, password: password, completion: { (res, error) in
                ...
                if let user = res?.user {
                    Auth.auth().currentUser?.sendEmailVerification{(error) in
                        if error == nil {
                            let alert = UIAlertController(title: "Email Sent", message: "This is an alert.", preferredStyle: .alert)
...
//            self.messagesController?.setupNavBarWithUser(user)
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor(r: 108, g: 198, b: 198)
